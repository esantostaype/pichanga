...
export const en = {
  ...
  teams: {
    ...
    moveName: "Move {name} to another side",
    moveToTeam: "Move {name} to {team}",
    moveTo: "Move to",
    moveHint: "Use the buttons on a row to move somebody or hand them the gloves.",
    moved: "Player moved",
    sidesTitle: "How many sides",
    sidesLine:
      "Applies the next time you shuffle. Auto lets the turnout decide, which is what it does on its own.",
    sidesAuto: "Auto",
    sidesOne: "{count} sides",
    tabAuto: "Auto",
    tabManual: "By hand",
    manualSidesLine:
      "Adding a side leaves it empty; taking one away sends its players back to the bench.",
    sideNumber: "Side {count}",
    sideEmpty: "Nobody yet",
    addPlayers: "Add players",
    pickForSide:
      "Pick whoever goes on this side. Somebody already on another one moves across.",
    addCount: "Add {count}",
    takeOut: "Take {name} out",
    waiting: "{count} still without a side",
    manualSave: "Save the sides",
    manualSaved: "Sides saved",
    needTwoSides: "Two sides at least",
    matchNight: "Match night",
...
export const es: Dictionary = {
  ...
  teams: {
    ...
    moveName: "Mover a {name} a otro equipo",
    moveToTeam: "Mover a {name} a {team}",
    moveTo: "Mover a",
    moveHint: "Usa los botones de cada fila para mover a alguien o darle los guantes.",
    moved: "Jugador movido",
    sidesTitle: "Cuántos equipos",
    sidesLine:
      "Se aplica la próxima vez que armes. Auto deja que decida la cantidad de jugadores, que es lo que hace solo.",
    sidesAuto: "Auto",
    sidesOne: "{count} equipos",
    tabAuto: "Automático",
    tabManual: "Manual",
    manualSidesLine:
      "Agregar un equipo lo deja vacío; quitar uno manda a sus jugadores de vuelta a la banca.",
    sideNumber: "Equipo {count}",
    sideEmpty: "Todavía nadie",
    addPlayers: "Agregar jugadores",
    pickForSide:
      "Elige quiénes van en este equipo. Si alguien ya está en otro, se cambia.",
    addCount: "Agregar {count}",
    takeOut: "Sacar a {name}",
    waiting: "{count} todavía sin equipo",
    manualSave: "Guardar los equipos",
    manualSaved: "Equipos guardados",
    needTwoSides: "Mínimo dos equipos",
    matchNight: "Partido en vivo",
